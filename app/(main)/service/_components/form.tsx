...
import ServiceFormConfiguration from "@/app/(main)/service/_components/form-configuration";
import {
  QuestionFormValues,
  ServiceFormValues,
  serviceSchema,
    ...
    <>
      ...
      {onDelete && (
        <DeleteSection
          ...
          description="Once you delete a service, there is no going back. All data associated with this service will be permanently removed. Please be certain."

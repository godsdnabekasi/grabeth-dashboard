...
interface ChurchLocationCardListProps {
  data?: {
    name?: string;
    address?: string;
    type?: LocationType;
        ...
        {data ? (
          <>
            <div className="flex flex-1 gap-3 items-start">
              <div
                className={cn("bg-slate-200 text-slate-700 p-2 rounded-full")}
              >
...
export default ChurchLocationCardList;
